                    ...
                    if (text != null) {
                        switch (text) {
                            ...
                            case "Kontrakt to’lovi":
                                userService.groupAndContact(update);
                                break;


                            case "Turar joy yoki kontarkt to'lovi":
                                userService.contractOrHome(update);
                                break;
                            case "Rus tili":
                            case "Ingliz tili":
                            case "SMM":
                            ...
                            default:
                                ...
                                } else if (user.getUserState().equals(UserStateNames.GROUP_CONTACT.name())) {
